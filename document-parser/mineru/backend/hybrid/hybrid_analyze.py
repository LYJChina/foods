            ...
            progress_callback(
                {
                    ...
                    "message": f"Processing 0/{page_count} pages",
                }
            )
        logger.info(
                        ...
                        progress_callback(
                            {
                                ...
                                "total_windows": total_windows,
                                "message": (
                                    f"Processed {completed_pages}/{page_count} pages"
                                ),
                            }
                        )
            ...
            progress_callback(
                {
                    ...
                    "total_pages": page_count,
                    "message": "Generating Markdown and final results",
                }
            )
